...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" id="form-edit-product" spellcheck="false">
                @csrf
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="nama_produk" name="nama_produk" class="form-control" placeholder="Masukkan nama produk" value="{{ $product->product_name }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="harga" name="harga" class="form-control" placeholder="Masukkan harga" value="{{ $product->price }}">
                        </div>    
                    ...
                    <div class="col-lg-6">
                        <div id="result">{!! $product->description !!}</div>
                    </div>
...
@push('js')
    ...
    <script>
        ...
        $('#form-edit-product').on('submit', function(e) {
            ...
            let url = '{{ url('dashboard/products/update') }}';
